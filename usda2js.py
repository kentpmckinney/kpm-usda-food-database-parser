...
with open(srcPath + "nutrient.csv", "r") as srcNutrientList: 
    ...
    nutrientListReader = csv.reader(srcNutrientList.read().splitlines(), delimiter=',', quotechar='"')
...
with open(srcPath + "food.csv", "r") as srcFoods:
    ...
    foodReader = csv.reader(srcFoods.read().splitlines(), delimiter=',', quotechar='"')
...
with open(srcPath + "food_nutrient.csv", "r") as srcNutrients:
    ...
    foodNutrientReader = csv.reader(srcNutrients.read().splitlines(), delimiter=',', quotechar='"')
